...
df = pd.read_csv('/workspace/Regularized-Linear-Regression/data/processed/df_data.csv')
...
filename='/workspace/Regularized-Linear-Regression/models/lasso_model1.sav'
pickle.dump(pipeline1, open(filename, 'wb'))

filename='/workspace/Regularized-Linear-Regression/models/lasso_model2.sav'
pickle.dump(pipeline2, open(filename, 'wb'))

filename='/workspace/Regularized-Linear-Regression/models/ols_model1.sav'
pickle.dump(ols_model1, open(filename, 'wb'))

filename='/workspace/Regularized-Linear-Regression/models/ols_model2.sav'
